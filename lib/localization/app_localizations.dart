...
class AppLocalizations {
  ...
  static const _values = <String, Map<String, String>>{
    'en': {
      ...
      'homeEditDailyGoal': 'Edit Daily Goal',
      'homeVideos': 'Videos',
      'homeQuizzes': 'Quizzes',
      'homeCancel': 'Cancel',
      'homeSave': 'Save',
      'homeVideosProgress': 'Videos: {completed}/{target}',
      'homeQuizzesProgress': 'Quizzes: {completed}/{target}',
      'homeErrorLoadingGoal': 'Error loading goal: {error}',
      'logout': 'Log out',
      'language': 'Language',
      'english': 'English',
      'khmer': 'Khmer',
      ...
      'resourceYearsTitle': 'Choose a year',
      'resourceYearsDescription':
          'Select an exam year to browse its available study materials.',
      'resourceCount': '{count} resources',
      'resourceYearsLoadFailed': 'Could not load resource years.',
      'resourcesForYearTitle': 'Resources for {year}',
      'resourcesForYearDescription':
          'Browse exam papers and revision materials, or filter the list by subject.',
      'filterBySubject': 'Filter by subject',
      'allSubjects': 'All subjects',
      'noResourcesForSubject': 'No resources are available for this subject.',
      'resourcesForYearLoadFailed': 'Could not load resources for this year.',
      'resourceDocumentInformation': 'Document information',
      'resourceSubjectLabel': 'Subject',
      'resourceYearLabel': 'Year',
      'resourceTypeLabel': 'Type',
      'resourcePagesLabel': 'Pages',
      'resourceDurationLabel': 'Duration',
      'resourcePdfViewer': 'PDF viewer',
      'resourceZoomOut': 'Zoom out',
      'resourceZoomIn': 'Zoom in',
      'resourceResetZoom': 'Reset zoom',
      ...
      'choosePlanSubtitle':
          'Unlock full access to quizzes, AI tutor, and study materials.',
      'monthly': 'Monthly',
      'yearly': 'Yearly',
      'savePercent': 'Save 20%',
      ...
      'bankTransferDesc':
          'Direct transfer via Mobile Banking or Bakong KHQR.',
      ...
      'uploadPayslipDesc':
          'Tap to select or attach your payment receipt (JPG, PNG).',
      'payslipAttached': 'Payslip attached successfully',
      'changeFile': 'Change',
      'removeFile': 'Remove',
      'pleaseUploadPayslip': 'Please attach a payslip before submitting.',
      'submitPayment': 'Submit Payment',
      'submittingPayment': 'Submitting...',
      'paymentSuccessTitle': 'Payment Submitted!',
      'paymentSuccessDesc':
          'Your payment receipt has been submitted for verification. Your subscription will be activated once confirmed.',
      ...
      'quizSelectAnswer': 'Select an answer before submitting.',
    ...
    'km': {
      ...
      'homeEditDailyGoal': 'កែប្រែគោលដៅប្រចាំថ្ងៃ',
      'homeVideos': 'វីដេអូ',
      'homeQuizzes': 'កម្រងសំណួរ',
      'homeCancel': 'បោះបង់',
      'homeSave': 'រក្សាទុក',
      'homeVideosProgress': 'វីដេអូ៖ {completed}/{target}',
      'homeQuizzesProgress': 'កម្រងសំណួរ៖ {completed}/{target}',
      'homeErrorLoadingGoal': 'មានបញ្ហាក្នុងការទាញយកគោលដៅ៖ {error}',
      'logout': 'ចាកចេញ',
      'language': 'ភាសា',
      'english': 'អង់គ្លេស',
      'khmer': 'ខ្មែរ',
      ...
      'resourceYearsTitle': 'ជ្រើសរើសឆ្នាំ',
      'resourceYearsDescription':
          'ជ្រើសរើសឆ្នាំប្រឡង ដើម្បីមើលឯកសារសិក្សាដែលមាន។',
      'resourceCount': '{count} ឯកសារ',
      'resourceYearsLoadFailed': 'មិនអាចទាញយកបញ្ជីឆ្នាំបានទេ។',
      'resourcesForYearTitle': 'ឯកសារសម្រាប់ឆ្នាំ {year}',
      'resourcesForYearDescription':
          'មើលវិញ្ញាសា និងឯកសាររំលឹកមេរៀន ឬច្រោះតាមមុខវិជ្ជា។',
      'filterBySubject': 'ច្រោះតាមមុខវិជ្ជា',
      'allSubjects': 'គ្រប់មុខវិជ្ជា',
      'noResourcesForSubject': 'មិនមានឯកសារសម្រាប់មុខវិជ្ជានេះទេ។',
      'resourcesForYearLoadFailed': 'មិនអាចទាញយកឯកសារសម្រាប់ឆ្នាំនេះបានទេ។',
      'resourceDocumentInformation': 'ព័ត៌មានឯកសារ',
      'resourceSubjectLabel': 'មុខវិជ្ជា',
      'resourceYearLabel': 'ឆ្នាំ',
      'resourceTypeLabel': 'ប្រភេទ',
      'resourcePagesLabel': 'ទំព័រ',
      'resourceDurationLabel': 'រយៈពេល',
      'resourcePdfViewer': 'កម្មវិធីមើល PDF',
      'resourceZoomOut': 'បង្រួម',
      'resourceZoomIn': 'ពង្រីក',
      'resourceResetZoom': 'កំណត់ទំហំឡើងវិញ',
      ...
      'upgrade': 'ដំឡើង',
      'upgradePlan': 'ដំឡើងគម្រោង',
      'choosePlan': 'ជ្រើសរើសគម្រោងរបស់អ្នក',
      'choosePlanSubtitle':
          'ដោះសោការចូលប្រើពេញលេញនូវសំណួរ AI Tutor និងឯកសារសិក្សា។',
      'monthly': 'ប្រចាំខែ',
      'yearly': 'ប្រចាំឆ្នាំ',
      'savePercent': 'ចំណេញ ២០%',
      'mostPopular': 'ពេញនិយមបំផុត',
      'current': 'បច្ចុប្បន្ន',
      'selectPlan': 'ជ្រើសរើសគម្រោង',
      'perMonth': '/ខែ',
      'perYear': '/ឆ្នាំ',
      'billedAnnually': 'គិតប្រាក់ប្រចាំឆ្នាំ',
      'paymentMethod': 'វិធីសាស្ត្រទូទាត់ប្រាក់',
      'paymentMethodSubtitle':
          'ជ្រើសរើសវិធីសាស្ត្រដែលអ្នកចង់ទូទាត់ប្រាក់។',
      'bankTransfer': 'ផ្ទេរប្រាក់តាមធនាគារ',
      'bankTransferDesc':
          'ផ្ទេរប្រាក់ផ្ទាល់តាមកម្មវិធីធនាគារ ឬបាគង KHQR។',
      ...
      'transferReference': 'លេខយោងការទូទាត់',
      'copy': 'ចម្លង',
      'copiedToClipboard': 'បានចម្លងទៅក្ដារតម្បៀតខ្ទាស់',
      'uploadPayslip': 'ផ្ទុកវិក្កយបត្រឡើង',
      'uploadPayslipDesc':
          'ចុចដើម្បីជ្រើសរើស ឬភ្ជាប់វិក្កយបត្របង់ប្រាក់ (JPG, PNG)។',
      'payslipAttached': 'បានភ្ជាប់វិក្កយបត្រដោយជោគជ័យ',
      'changeFile': 'ប្តូរ',
      'removeFile': 'លុបចេញ',
      'pleaseUploadPayslip': 'សូមភ្ជាប់វិក្កយបត្រមុននឹងបញ្ជូន។',
      'submitPayment': 'បញ្ជូនការទូទាត់',
      'submittingPayment': 'កំពុងបញ្ជូន...',
      'paymentSuccessTitle': 'បានបញ្ជូនការទូទាត់ជោគជ័យ!',
      'paymentSuccessDesc':
          'វិក្កយបត្ររបស់អ្នកត្រូវបានបញ្ជូនសម្រាប់ការផ្ទៀងផ្ទាត់។ គម្រោងរបស់អ្នកនឹងត្រូវបានដំណើរការនៅពេលបញ្ជាក់រួចរាល់។',
      'viewPaymentHistory': 'មើលប្រវត្តិទូទាត់',
      'done': 'រួចរាល់',
      'back': 'ត្រឡប់ក្រោយ',
